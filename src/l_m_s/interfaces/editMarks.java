...
public class editMarks extends javax.swing.JFrame {
    ...
    int section;
    public editMarks(showMarks t,int secID) {
        initComponents();
        showMarks=t;
        section = secID;
        Admin a = Admin.getinstance();
        Label_Roll.setText("Teacher ID: "+Integer.toString(showMarks.tfr.temp.gettId()) );
        Label_Fname.setText("Teacher First Name: "+showMarks.tfr.temp.getfName());
        Label_LastName.setText("Teacher Last Name: "+showMarks.tfr.temp.getlName());
        Label_Contact.setText("Teacher Contact: "+Integer.toString(showMarks.tfr.temp.getContact()));
        Label_Gender.setText("Teacher Gender: "+showMarks.tfr.temp.getGender());
        Label_Address.setText("Teacher Address: "+showMarks.tfr.temp.getAddress());
        tmodel = (DefaultTableModel) jTable1.getModel();
        studying= new ArrayList<>();
        studying= a.getAttendanceOfAllStudents(secID);
        if(studying.isEmpty()){
            errorLabel.setText("!Currently NO Student in Section!");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        for (int i = 0; i < studying.size(); i++) {
            ...
            if(d==null)
            {
                errorLabel.setText("Marks not updated properly");
            }
            else
            {
                Admin a = Admin.getinstance();
                a.addMarks(section, studying.get(i).getStudentID(),d);
            }
        }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        showMarks sm = new showMarks(showMarks.tfr, section);
        sm.setVisible(true);
