...
public class showAttendance extends javax.swing.JFrame {
    ...
    int section;
    public showAttendance(teacherFrame t,int secID) {
        initComponents();
        tfr=t;
        section = secID;
        ...
        else
        {
            ...
            tmodel.addColumn("Student ID");
            for (int j = 0; j < studying.get(0).getAttendance().size(); j++) {
                tmodel.addColumn(studying.get(0).getAttendance().get(j).getDate());
            }

            for (int i = 0; i < studying.size(); i++) {
             
                tmodel.insertRow(tmodel.getRowCount(),new Object[]{studying.get(i).getStudentID()} );
                for (int j = 0; j < studying.get(i).getAttendance().size(); j++) {
                    tmodel.setValueAt(studying.get(i).getAttendance().get(j).getStatus(), i, j+1);
                }
            }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        addAttendance add = new addAttendance(this, section);
        add.setVisible(true);
