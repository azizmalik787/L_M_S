...
public class addEvaluation extends javax.swing.JFrame {
    ...
    public addEvaluation(teacherFrame t,int secID) {
        initComponents();
        tfr=t;
        section = secID;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        for (int i = 0; i < studying.size(); i++) {
            ...
            {
                Admin a = Admin.getinstance();
                a.addGrade(section, studying.get(i).getStudentID(),grade);
            }
            else
            {
                errorLabel.setText("Grade not updated properly");
            }
        }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        showEvaluation show = new showEvaluation(tfr, section); //logout
