...
public class addAttendance extends javax.swing.JFrame {
    ...
    showAttendance showatdfr;
    DefaultTableModel tmodel;
    ArrayList<studentStudying> studying;
    int section;
    public addAttendance(showAttendance t,int secID) {
        initComponents();
        showatdfr=t;
        section =secID;
        Admin a = Admin.getinstance();
        Label_Roll.setText("Teacher ID: "+Integer.toString(showatdfr.tfr.temp.gettId()) );
        Label_Fname.setText("Teacher First Name: "+showatdfr.tfr.temp.getfName());
        Label_LastName.setText("Teacher Last Name: "+showatdfr.tfr.temp.getlName());
        Label_Contact.setText("Teacher Contact: "+Integer.toString(showatdfr.tfr.temp.getContact()));
        Label_Gender.setText("Teacher Gender: "+showatdfr.tfr.temp.getGender());
        Label_Address.setText("Teacher Address: "+showatdfr.tfr.temp.getAddress());
        ...
        for (int i = 0; i < studying.size(); i++) {
            tmodel.insertRow(tmodel.getRowCount(),new Object[]{studying.get(i).getStudentID(),""} );        
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        for (int i = 0; i < studying.size(); i++) {
            Object obj = tmodel.getValueAt(i, 1);
            String str = obj.toString();
            if(str==null || str=="")
            {
                errorLabel.setText("Status not updated properly");
            }
            else
            {
                Admin a = Admin.getinstance();
                a.addAttendance(section, studying.get(i).getStudentID(),str.charAt(0));
            }
        }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        showAttendance show = new showAttendance(showatdfr.tfr, section);
